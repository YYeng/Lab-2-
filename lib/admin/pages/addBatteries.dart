...
class AddBatteries extends StatefulWidget {
  @override
  _AddBatteriesState createState() => _AddBatteriesState();
}

class _AddBatteriesState extends State<AddBatteries> {
  ...
  //ProgressDialog pr;
  File _image;
  String pathAsset = 'asset/images/battery.png';
  ...
  Future<void> _addProduct(
    ...
    // http.post(
    //     Uri.parse('https://crimsonwebs.com/s270737/cvbattery/php/addProducts.php'),
    //     body: {
    //       "name": name,
    //       "type": type,
    //       "price": price,
